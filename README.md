...
這是最初階 3D 遊戲原型。已測 Chrome 桌面與橫式手機觸控模擬；March 版的真實 iPhone／iPad Safari 尚未覆測。March 網頁模型為 4.88 MB，首次開啟仍需下載與解碼。另有兩處待老師明確核准後才能修正：藍色電子動畫抵達鋁箔的視覺終點，以及第五題驗證文字與原教材逐字一致。未實作金屬球關卡、服裝切換、其他房間或手把操作。
